...
// 
const hartIco = document.querySelector("div.detailsTitle >div a:nth-of-type(1)");
const mouseIco = document.querySelector("div.detailsTitle >div a:nth-of-type(2)");
const lightIco = document.querySelector("div.detailsTitle >div a:nth-of-type(3)");
const designSpanIco = document.querySelector(".projects>div:nth-of-type(1)>span");
const vintageSpanIco = document.querySelector(".projects>div:nth-of-type(2)>span");
const brandingSpanIco = document.querySelector(".projects>div:nth-of-type(3)>span");
...
const icons = [hartIco, mouseIco, lightIco, designSpanIco, vintageSpanIco, brandingSpanIco, settingsIco, designIco, rolleIco, attachmentIco];
const blocks = [mouse, light, settings, design, rolle, attachment, circleSettings];
...
const strokeDasharray = document.querySelector('circle.second').getAttribute('stroke-dasharray');
...
const animateCircleBar = () => {
    ...
    percentNumber++;
    if (percentNumber <= strokeDasharray * (percentServices[index].brandingValue / 100)) {
        circleBar[0].setAttribute('stroke-dashoffset', percentNumber);
    }
    if (percentNumber <= strokeDasharray * (percentServices[index].webValue / 100)) {
        circleBar[1].setAttribute('stroke-dashoffset', percentNumber);
    }
    if (percentNumber <= strokeDasharray * (percentServices[index].uiValue / 100)) {
...
linkList.forEach(btn => btn.addEventListener('click', () => {
...
for (var i = 0; i < icons.length; i++) {
    icons[i].addEventListener('click', function () {
        if (this == hartIco) {
            ...
            document.querySelector(".projects>div:nth-of-type(1)").classList.toggle("growsX");
        } else if (this == vintageSpanIco) {
            vintageSpanIco.classList.toggle("clear");
            brandingSpanIco.classList.remove("clear");
            designSpanIco.classList.remove("clear");
            document.querySelector(".projects>div:nth-of-type(2)").classList.toggle("growsX");
        } else if (this == brandingSpanIco) {
            vintageSpanIco.classList.remove("clear");
            brandingSpanIco.classList.toggle("clear");
            designSpanIco.classList.remove("clear");
            document.querySelector(".projects>div:nth-of-type(3)").classList.toggle("growsX");
        }
    })
}
...
const clickChange = (e) => {
    ...
    if (currentDot >= 0) {
        ...
        webDesignPercent.textContent = teamObject[currentDot].webDesignPercent + '%';
